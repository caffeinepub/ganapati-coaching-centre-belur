...
export class Backend implements backendInterface {
    ...
    async createStudent(arg0: string, arg1: bigint): Promise<bigint> {
    ...
    async getAllFees(): Promise<Array<[bigint, Array<boolean>]>> {
        if (this.processError) {
            try {
    ...
    async loginStudent(arg0: bigint, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async markFeePaid(arg0: bigint, arg1: bigint, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
